...
#         icon_paths = [
#             "C:/projects/Airavata_2025-main/Airavata_2025-main/Icons/app-development.png",
#             "C:/projects/Airavata_2025-main/Airavata_2025-main/Icons/cloud-services.png",
#             "C:/projects/Airavata_2025-main/Airavata_2025-main/Icons/ai.png"
#         ]
...
class Dashboard:
    def __init__(self, root, go_to_main_callback):
        ...
        # Icon filenames (relative to Icons folder)
        icon_files = [
            "app-development.png",
            "cloud-services.png",
            "ai.png"
        ...
        for icon_file in icon_files:
            ...
            try:
                ...
                if os.path.exists(icon_path):
                    ...
                    # Create a placeholder button if icon is missing
                    placeholder_button = tk.Button(self.toolbar_frame, text="📱", bg="#34495e", 
                                                 fg="white", font=("Arial", 16), command=self.on_icon_click)
                    placeholder_button.pack(side=tk.LEFT, padx=5)
                    placeholder_button.bind("<Enter>", lambda e, b=placeholder_button: on_enter(e, b))
                    placeholder_button.bind("<Leave>", lambda e, b=placeholder_button: on_leave(e, b))
            except Exception as e:
                print(f"Error loading toolbar icon {icon_file}: {e}")
                # Create a text-based placeholder button
                placeholder_button = tk.Button(self.toolbar_frame, text="🔧", bg="#34495e", 
                                             fg="white", font=("Arial", 16), command=self.on_icon_click)
                placeholder_button.pack(side=tk.LEFT, padx=5)
                placeholder_button.bind("<Enter>", lambda e, b=placeholder_button: on_enter(e, b))
